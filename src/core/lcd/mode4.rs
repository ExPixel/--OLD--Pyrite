...
pub fn render_mode_4(dispcnt: u16, memory: &mut GbaMemory, line: u16, line_buffer: &mut [GbaPixel]) {
	...
	for col in 0..240 {
		...
		let pixel = convert_rgb5_to_rgb8(palette.direct_read16((pal_ref as usize) * 2));
